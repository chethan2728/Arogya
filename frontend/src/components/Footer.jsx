  ...
  return (
    <div className='md:mx-10'>
      <div className='flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-40 text-sm soft-text'>
        ...
        {/*----center section ----- */}
        <div>
            <p className='text-xl font-medium mb-5 surface-text'>Company</p>
        ...
        {/*-----left section ----- */}
        <div>
            <p className='text-xl font-medium mb-5 surface-text'>GET IN TOUCH</p>
            <ul className='flex flex-col gap-2'>
                <li>9980550913</li>
      ...
      {/* -------Copyright text --------- */}
      <div>
        <hr className='border-cyan-200/20'/>
        <p className='py-5 text-sm text-center soft-text'>Copyright 2025@ CareXpert - All Right Reserved</p>
      </div>
    </div>
  )
}
